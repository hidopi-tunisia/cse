            ...
            {{-- <h2 class="font-light text-xl text-gray-700 sm:text-xl md:text-2xl">QUESTIONS GENERALES</h2> --}} <div
                ...
                <div class="faq-card">
                    ...
                    <div class="p-3"> <strong class="font-bold text-cse">Réponse&nbsp;:</strong> Oui, lorsque
                        ...
                        l’assurance. Il vous suffit de nous adresser par mail à <a href="mailto:agentcelignes@presenceassistance.com"> <strong class="text-cse">agentcelignes@presenceassistance.com</strong> </a> le
